...
included_log_groups = ['included-log-group-1', 'included-log-group-2']  # Add log groups to include

def should_include(log_group_name):
    return log_group_name in included_log_groups
...
def lambda_handler(event, context):
    ...
    for log_group in log_groups:
        ...
        if not should_include(log_group_name):
            continue  # Skip log groups not in the included list
